...
- Active review round: per-item action/incidental ingestion authority is independently clear; eight medium config/projection/product findings remain queued.
