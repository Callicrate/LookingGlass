...
- The real ignored local database was snapshotted through the new command to `.local/backups/rookery-20260829-0613.sqlite3`; the standalone 323,584-byte copy reports integrity `ok` at migration `0013`.
